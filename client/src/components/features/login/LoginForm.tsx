...
export function LoginForm({
    ...
    const formItemData: FormFieldItem<typeof loginSchema>[] = [
        {
            label: "Username",
            name: "username",
            render: ({ field }) => (
            ...
            render: ({ field, form }) => (
                <div className="relative">
                    ...
                    <Input
                        ...
                        className="pl-10 pr-10 h-12 bg-background/50 border-border/50 focus:border-primary/50 focus:bg-background transition-all duration-200"
                        {...field}
    ...
    return (
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Card className="border-0 shadow-2xl bg-gradient-to-br from-card via-card to-card/95 backdrop-blur-sm">
                <CardHeader className="space-y-6">
                    ...
                    <div className="flex justify-center">
                        <div className="relative">
                            <Icon name="PersonStanding" className="h-16 w-auto object-contain" />
                        </div>
                    </div>
            ...
            <div className="text-center text-sm text-muted-foreground">
                <p>© 2025 CONFIG VAULT. All rights reserved.</p>
            </div>
        </div>
    )
}
